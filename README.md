...
The goal was to move beyond just Wazuh rules detection and demonstrate the ability to write, debug, and validate custom detection rules through to live alert verification in the dashboard. The repository contains an xml file containing all the local rules,an alert triage walkthrough document,a wazuh archictecture diagram and screenshots showing each step.
# Tools Used
